...
def main() :
    ...
    outDir = '/home/zchen/neural/newcaf/newindex/muonfile/epoch50new'
    ...
    train_loader = torch.utils.data.DataLoader(muonEffDataset.muonEffDataset('~/neural/newcaf/newindex/muonfile/muoneff_train.h5', 'h'), batch_size=200, shuffle=True, num_workers=4, collate_fn = muonEffDataset.collate)
    test_loader =  torch.utils.data.DataLoader(muonEffDataset.muonEffDataset('~/neural/newcaf/newindex/muonfile/muoneff_test.h5', 'h'), batch_size=200, shuffle=True, num_workers=4, collate_fn =  muonEffDataset.collate)
